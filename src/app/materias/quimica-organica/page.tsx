        ...
        <div class="container sidebar-container">
            ...
            <section class="content-area">
                ...
                <div id="topic-1-0" class="topic-content">
                    ...
                    <img src="assets/01.png" alt="Introdução - Fundamentos de Estrutura" style="display: block; margin: 20px auto 0 auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                </div>
                ...
                <div id="topic-1-1" class="topic-content">
                    ...
                    <img src="assets/oct.png" alt="Regra do Octeto" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <ul>
                        ...
                        <img src="assets/lig_io.png" alt="Ligação Iônica" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/lig-cov.png" alt="Ligação Covalente" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <img src="assets/tp.png" alt="Tabela Periódica Eletronegatividade" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/lig_po.png" alt="Ligação Covalente Polar" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        ...
                        <img src="assets/lig_apo.png" alt="Ligação Covalente Apolar" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
                ...
                <div id="topic-1-2" class="topic-content">
                    ...
                    <ul>
                        ...
                        <img src="assets/sp3.png" alt="Hibridização sp3" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/sp2.png" alt="Hibridização sp2" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/sp.png" alt="Hibridização sp" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
                ...
                <div id="topic-1-3" class="topic-content">
                    ...
                    <ul>
                        ...
                        <img src="assets/fo_lew.png" alt="Estruturas de Lewis" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        ...
                        <img src="assets/fo_hon.png" alt="Mnemônico HONC" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/fo_mol.png" alt="Fórmula Molecular" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/fo_bas.png" alt="Notação em Bastão" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
                ...
                <div id="topic-1-4" class="topic-content">
                    ...
                    <img src="assets/res.png" alt="Ressonância" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <img src="assets/cf.png" alt="Cargas Formais" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                </div>
                ...
                <div id="topic-2-0" class="topic-content">
                    ...
                    <img src="assets/hort.png" alt="Hortênsias Ácido-Base" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <div id="topic-2-1" class="topic-content">
                    ...
                    <ul>
                        ...
                        <img src="assets/te_arr.png" alt="A Lente de Arrhenius" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/te_bl.png" alt="A Lente de Brønsted-Lowry" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/te_lew.png" alt="A Lente de Lewis" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
                ...
                <div id="topic-2-2" class="topic-content">
                    ...
                    <img src="assets/pka.png" alt="O Termômetro da Força" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                </div>
                ...
                <div id="topic-2-3" class="topic-content">
                    ...
                    <ul>
                        ...
                        <img src="assets/ab_ele.png" alt="Eletronegatividade" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/ab_hib.png" alt="Hibridização e Acidez" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/ab_res.png" alt="Ressonância e Efeito Indutivo" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
                ...
                <div id="topic-2-4" class="topic-content">
                    ...
                    <ul>
                        ...
                        <img src="assets/ab_ac.png" alt="Ácidos Carboxílicos" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/ab_ami.png" alt="Aminas" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                        ...
                        <img src="assets/ab_alc.png" alt="Álcoois e Éteres" style="display: block; margin: 20px auto; max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                        </li>
                    </ul>
                </div>
 ...
 /              \             /        C                C           C          C
  (CADEIRA - Estável)            (BARCO - Instável)
                ...
                <div id="topic-4-1" class="topic-content">
                    <h2>4. Estereoquímica - Quiralidade e Centros Estereogênicos (Carbonos Quirais).</h2>
                    <p>Quiralidade e Centros Estereogênicos (Carbonos Quirais).</p>
                </div>
                ...
                <div id="topic-4-3" class="topic-content">
                    <h2>4. Estereoquímica - Enantiômeros, Diastereoisômeros e Compostos Meso.</h2>
                    <p>Enantiômeros, Diastereoisômeros e Compostos Meso.</p>
                </div>

                <div id="topic-4-4" class="topic-content">
                    <h2>4. Estereoquímica - Atividade Óptica e Excesso Enantiomérico.</h2>
                    <p>Atividade Óptica e Excesso Enantiomérico.</p>
                </div>

                <div id="topic-5-1" class="topic-content">
                    <h2>5. Introdução às Reações Orgânicas e Mecanismos - Tipos de Reações</h2>
                    <p>Adição, eliminação, substituição e rearranjo.</p>
                </div>

                <div id="topic-5-2" class="topic-content">
                    <h2>5. Introdução às Reações Orgânicas e Mecanismos - Intermediários de Reação</h2>
                    <p>Carbocátions, carbanions e radicais livres.</p>
                </div>

                <div id="topic-5-3" class="topic-content">
                    <h2>5. Introdução às Reações Orgânicas e Mecanismos - Termodinâmica e Cinética</h2>
                    <p>Diagramas de energia de reação, estados de transição e intermediários.</p>
                </div>

                <div id="topic-5-4" class="topic-content">
                    <h2>5. Introdução às Reações Orgânicas e Mecanismos - Mecanismos de Setas Curvas</h2>
                    <p>Representação do fluxo de elétrons.</p>
                </div>
